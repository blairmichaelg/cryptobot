...
class EarningsTracker:
    ...
    def record_runtime_cost(self, faucet: str, duration_seconds: float, time_cost_per_hour: float,
                            proxy_cost_per_hour: float, proxy_used: bool = False) -> None:
    ...
    def get_hourly_roi(self, faucet: Optional[str] = None, days: int = 7) -> Dict[str, Dict[int, float]]:
        ...
        earnings_by_faucet_hour: Dict[str, Dict[int, Dict[str, float]]
