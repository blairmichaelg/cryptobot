...
class AdBTCBot(FaucetBot):
    ...
    async def login(self) -> bool:
        ...
        try:
            ...
            await self.page.goto(f"{self.base_url}/index/enter", wait_until="domcontentloaded", timeout=60000)
    ...
    async def claim(self) -> ClaimResult:
        ...
        try:
            ...
            await self.page.goto(f"{self.base_url}/surf/browse", wait_until="domcontentloaded", timeout=60000)
    ...
    async def withdraw(self) -> ClaimResult:
        ...
        try:
            ...
            await self.page.goto(f"{self.base_url}/index/withdraw", wait_until="domcontentloaded", timeout=60000)
    ...
    def get_jobs(self):
        ...
        Jobs include:
        1. Faucet Claim - Validates login and extracts balance
        2. Surf Ads - Main earning method (PTC ads)
        3. Withdrawal - Daily withdrawal to FaucetPay
        ...
        # Job 1: Faucet Claim (Login verification and balance check)
        jobs.append(Job(
            priority=1,
            next_run=time.time(),
            name=f"{self.faucet_name} Claim",
        ...
        jobs.append(Job(
            priority=2,
            next_run=time.time() + 120,  # Start 2 minutes after claim
            name=f"{self.faucet_name} Surf",
            profile=None,
            faucet_type=f_type,
            job_type="ptc_wrapper"
        ...
        # Job 3: Withdrawal Job
        jobs.append(Job(
            priority=5,
            next_run=time.time() + 3600,  # Start 1 hour after first claim
            name=f"{self.faucet_name} Withdraw",
            profile=None,
            faucet_type=f_type,
            job_type="withdraw_wrapper"
