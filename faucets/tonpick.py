"""
TonPick Bot - Toncoin faucet from the Pick.io family.

Inherits login from PickFaucetBase and implements TON-specific claim logic.
"""
import asyncio
import logging
...
class TonPickBot(PickFaucetBase):
    ...
    async def get_balance(self) -> str:
        """Extract TON balance from the page.
                    ...
                    if await element.count() > 0 and await element.first.is_visible():
                        ...
                        if balance_text:
                            ...
                            if balance and balance != "0":
                                logger.debug(f"[{self.faucet_name}] Balance extracted: {balance} TON")
                                return balance
    ...
    async def claim(self) -> ClaimResult:
        """Perform TON claim with stealth and error handling.
        ...
        try:
            ...
            logger.info(f"[{self.faucet_name}] Current balance: {current_balance} TON")
